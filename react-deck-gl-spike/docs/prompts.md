...
- Add a Prettier configuration file and ignore file.
- Update the project's linting scripts to include Prettier.
...
```
Add oxlint support to the project.
- Create a feature branch from main.
- Install oxlint as a development dependency.
- Add a oxlint configuration file.
- Update the project's linting scripts to include oxlint.
- Commit the changes with a descriptive message.
- Open a pull request for review.
```
...
```
Add React Router support to the project.
- Create a feature branch from main.
- Install react-router-dom as a dependency.
- Configure the main application component to use React Router.
- Set up basic routes for the application.
- Commit the changes with a descriptive message.
- Open a pull request for review.
```
